	...
	if(isset($_POST['desc'])){
	 ...
	 //if inserting a multiple choice question, insert answers by this-
		if($type == 'mc'){
		 //if answer1 is marked correct, do this--
			if($isCorrect == "answer1"){
				$sql2 = mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '2')")or die(mysql_error());
				mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '-1')")or die(mysql_error());
				mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer3', '-1')")or die(mysql_error());
				mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer4', '-1')")or die(mysql_error());
				$msg = 'Thanks, question no.'.$lastId.' has been added';
			  	header('location: admin.php?msg='.$msg.'');
				exit();
			}
		 //if answer2 is marked correct, do this--
			if($isCorrect == "answer2"){
				mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '-1')")or die(mysql_error());
				$sql2 = mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '2')")or die(mysql_error());
				mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer3', '-1')")or die(mysql_error());
				mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer4', '-1')")or die(mysql_error());
				$msg = 'Thanks, question no.'.$lastId.' has been added';
		  		header('location: admin.php?msg='.$msg.'');
		 ...
		 //if answer3 is marked correct, do this--
			if($isCorrect == "answer3"){
				mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '-1')")or die(mysql_error());
				mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '-1')")or die(mysql_error());
				$sql2 = mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer3', '2')")or die(mysql_error());
				mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer4', '-1')")or die(mysql_error());
				$msg = 'Thanks, question no.'.$lastId.' has been added';
		  		header('location: admin.php?msg='.$msg.'');
				exit();
		 ...
		 //if answer4 is marked correct, do this--
			if($isCorrect == "answer4"){
				...
				mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '-1')")or die(mysql_error());
				mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer3', '-1')")or die(mysql_error());
				$sql2 = mysql_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer4', '2')")or die(mysql_error());
				$msg = 'Thanks, question no.'.$lastId.' has been added';
			  	header('location: admin.php?msg='.$msg.'');
				exit();
			}
					  			...
					  			<ul>
					  				...
					  				<li>Results
					  					<ul>
											  ...
											  <a href="javascript:text_users(\''.$m_quiz_name.'\')">
					  							<li>Result with Text</li>
											  </a>
...
<?php
//For displaying text answers

require_once("scripts/connect_db.php");

if(isset($_POST['usersText']) && $_POST['usersText'] != ""){
	$usersQ = $_POST['usersText'];
	...
	$m_output=' <table border="6" cellspacing="2" cellpadding="2">
	            <tr align="center">
					<th>Rank</th>
					<th>Email ID</th>
					<th>Marks</th>
...
<?php
//PHP for showing All Participants
	require_once("scripts/connect_db.php");

	if(isset($_POST['all_part']) && $_POST['all_part'] != ""){
		...
		$m_output=' <tr align="center">
						<th>Username</th>
						<th>Quiz Number</th>
					    <th>Taken the Quiz</th>
					    
					</tr>
				 ';

		$multipleSQL = mysql_query("SELECT * FROM participants");
			...
			while($m_row = mysql_fetch_array($multipleSQL)){
				...
				$m_quiz_id = $m_row['quiz_id'];
                $is_taken = 'No';
                $quiz_Number = $_POST['all_part'];
                $check = mysql_query(" SELECT id FROM quiz_takers 
										WHERE username = '$m_username'")or die(mysql_error());
...
*/
			...
			function text_users(qqizName){
				var x = new XMLHttpRequest();
				var url = "admin.php";
				var vars = 'usersText='+qqizName;
				x.open("POST", url, true);
				x.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
				x.onreadystatechange = function() {
					if(x.readyState == 4 && x.status == 200) {
            ...
            function all_part(qqispart){
				var x = new XMLHttpRequest();
				var url = "admin.php";
				var vars = 'all_part='+qqispart;
				x.open("POST", url, true);
				x.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
				x.onreadystatechange = function() {
					if(x.readyState == 4 && x.status == 200) {
	...
	<body style="font-family: Arial;">
		...
		<div id="admin_menu">
			...
			<ul>
				...
				<li>Participants
			  		<ul>
				      <a href="new_part.php" target="_blank">
					    <li>Add Participants</li>
				      </a>
				      <a href="javascript:all_part('1');">
